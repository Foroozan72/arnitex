# import pycountry
# from basic_info import Country, City
...
#     obj = Country.objects.create(title=country.name, flag=flag_url)

# for subdivision in pycountry.subdivisions:
#     country = Country.objects.get(title=subdivision.country.name)
#     City.objects.create(title=subdivision.name, country=country)
